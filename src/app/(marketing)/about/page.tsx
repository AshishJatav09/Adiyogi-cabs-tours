...
export const metadata: Metadata = createMetadata({
  title: "About Us",
  description:
    "Learn about the premium spiritual travel vision, family-safe service values, and future-ready approach behind Adiyogi Cabs & Tour.",
  path: "/about",
});
      ...
      <main>
        <section className="bg-[linear-gradient(180deg,rgba(255,248,240,0.95),rgba(241,226,205,0.72))]">
          <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-[var(--color-muted)]">
              Adiyogi Cabs & Tour is designed to feel more like a guided travel
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          <SectionHeading
            ...
            description="These are the service pillars that make Adiyogi Cabs & Tour future-ready for deeper package, blog, admin, and booking expansion."
          />
        ...
        <CTASection
          ...
          title="Speak with Adiyogi Cabs & Tour for your next darshan route."
